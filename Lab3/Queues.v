...
Proof.
  intros.
  destruct q. unfold toList in H. unfold fst in H. unfold snd in H. simpl in H.  destruct l. destruct l0. 
    -  discriminate.
...
Proof.
  intros.
  pose proof dequeue_none_sound. pose proof dequeue_none_complete. split.
    + apply H0.
    + apply H. 
Qed.
